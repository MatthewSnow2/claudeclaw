...
async function refreshAll() {
  ...
  await Promise.all([loadInfo(), loadTasks(), loadMemories(), loadHealth(), loadTokens(), loadAgents(), loadHiveMind(), loadSummary(), loadProjects(), loadOrchestrationIssues(), loadMissionControl()]);
